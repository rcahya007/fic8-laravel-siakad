<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <li class="nav-item dropdown ">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>Subjects</span></a>
            <ul class="dropdown-menu">
                <li>
        ...
        <li class="nav-item dropdown ">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>Schedules</span></a>
            <ul class="dropdown-menu">
                <li>
